(function( Popcorn ) {
  ...
  Popcorn.smart = function( target, src, options ) {
    var node = typeof target === "string" ? Popcorn.dom.find( target ) : target,
        ...
        wrappers = "HTMLYouTubeVideoElement HTMLDailymotionVideoElement HTMLVimeoVideoElement HTMLSoundCloudAudioElement HTMLJWPlayerVideoElement HTMLNullVideoElement ".split(" ");
